import {
  BookOpen, Globe, Award, ClipboardList, PenTool, CheckCircle, GraduationCap,
  Activity, Sparkles, BookMarked, Landmark, UserCheck, ShieldAlert,
  type LucideIcon,
} from "lucide-react";
...
export type TrainingTestItem = {
  id: string;
  label: string;
  fullTitle: string;
  category: "Language Proficiency" | "Academic & Licensing";
  desc: string;
  summary: string;
  duration: string;
  mode: string;
...
export const trainingTests: TrainingTestItem[] = [
  {
    id: "ielts",
    label: "IELTS",
